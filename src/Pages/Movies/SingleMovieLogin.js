...
const SingleMovieLogin = () => {
    ...
    const redirecting = () => {
        window.location.href = '/home/movies/list-movies'
    }
                                        ...
                                        <Row className="form-group" key={item.id}>
                                            <Col>
                                                <Card border="primary" style={{}}>
                                                    ...
                                                    <Card.Footer>
                                                        <Button as={NavLink} to={"../"} variant="primary">Back to list movies</Button>
                                                    </Card.Footer>
                                                </Card>
                                            </Col>
                                        </Row>
...
export default SingleMovieLogin